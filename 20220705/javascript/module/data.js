...
export const colorArr = ["tomato", "darkslateblue", "cadetblue", 'sandybrown']
...
export const tilteArr = ["Project-01", "Project-02","Project-03","contact"]
export const subTArr = ["Pet's Life", "Pet's Life","Pet's Life",""]